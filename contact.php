...
<form action = "inquire.php" method = "post" onsubmit = "return validate()" >
  ...
  <input type="text" id="fname" name="fname"> <p id="fnproblem" style="display:none;color:red;font-size:12px;padding:1px">This field is required.</p> <br>
  <label for="lname">Last name (required):</label>
  <input type="text" id="lname" name="lname"> <p id="lnproblem" style="display:none;color:red;font-size:12px;padding:1px">This field is required.</p> <br>
  <label for="email">Email (required):</label>
  <input type="email" id="email" name="email"> <p id="emproblem" style="display:none;color:red;font-size:12px;padding:1px">This field is required.</p> <br>
