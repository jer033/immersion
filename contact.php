...
<form action = "inquire.php" method = "post" onsubmit = "return validate()" >
  ...
  <input type="text" id="fname" name="fname"> <p id="fnproblem" style="color:red;font-size:24px;margin:1px"></p>
  <label for="lname">Last name (required):</label>
  <input type="text" id="lname" name="lname"> <p id="lnproblem" style="color:red;font-size:24px;margin:1px"></p>
  <label for="email">Email (required):</label>
  <input type="email" id="email" name="email"> <p id="emproblem" style="color:red;font-size:24px;margin:1px"></p>
  <label for="question">Your inquiry (required):</label><br>
  <textarea id="question" name="question" rows="8" cols="180"></textarea> <p id="quproblem" style="color:red;font-size:24px;margin:1px"></p> <br>
